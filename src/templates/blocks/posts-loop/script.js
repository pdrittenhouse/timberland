jQuery(document).ready(function ($) {
    ...
    jQuery.each(buttons, function () {
        ...
        const location = wrapper.find('.card').closest('.card-grid, .card-row, .card-group');
        ...
        const ajaxData = {
            ...
            grid_type: typeof wrapper.data('grid-type') !== 'undefined' && wrapper.data('grid-type') !== undefined ? wrapper.data('grid-type').replace(/\'/g, '"') : '',
        };
