...
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/src/patternlab/source/_patterns/00-protons"), "protons");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/src/patternlab/source/_patterns/01-atoms"), "atoms");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/src/patternlab/source/_patterns/02-molecules"), "molecules");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/src/patternlab/source/_patterns/03-organisms"), "organisms");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/src/patternlab/source/_patterns/04-templates"), "templates");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/src/patternlab/source/_patterns/05-pages"), "pages");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/dist/wp"), "assets");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/dist/wp/css"), "styles");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/dist/wp/img"), "images");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/dist/wp/fonts"), "fonts");
//  $loader->addPath(str_replace($_SERVER['SERVER_NAME'], '', get_template_directory_uri() . "/dist/wp/js"), "scripts");
